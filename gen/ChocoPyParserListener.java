...
public interface ChocoPyParserListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by the {@code program_Decl}
	 * labeled alternative in {@link ChocoPyParser#program}.
	 * @param ctx the parse tree
	 */
	void enterProgram_Decl(ChocoPyParser.Program_DeclContext ctx);
	/**
	 * Exit a parse tree produced by the {@code program_Decl}
	 * labeled alternative in {@link ChocoPyParser#program}.
	 * @param ctx the parse tree
	 */
	void exitProgram_Decl(ChocoPyParser.Program_DeclContext ctx);
	/**
	 * Enter a parse tree produced by the {@code program_Comments}
	 * labeled alternative in {@link ChocoPyParser#program}.
	 * @param ctx the parse tree
	 */
	void enterProgram_Comments(ChocoPyParser.Program_CommentsContext ctx);
	/**
	 * Exit a parse tree produced by the {@code program_Comments}
	 * labeled alternative in {@link ChocoPyParser#program}.
	 * @param ctx the parse tree
	 */
	void exitProgram_Comments(ChocoPyParser.Program_CommentsContext ctx);
	/**
