...
public interface ChocoPyParserVisitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by the {@code program_Decl}
	 * labeled alternative in {@link ChocoPyParser#program}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProgram_Decl(ChocoPyParser.Program_DeclContext ctx);
	/**
	 * Visit a parse tree produced by the {@code program_Comments}
	 * labeled alternative in {@link ChocoPyParser#program}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProgram_Comments(ChocoPyParser.Program_CommentsContext ctx);
	/**
